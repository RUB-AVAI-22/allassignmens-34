...
{
  new (message_memory) avai_messages::msg::BoundingBoxes(_init);
}

void BoundingBoxes_fini_function(void * message_memory)
{
  auto typed_message = static_cast<avai_messages::msg::BoundingBoxes *>(message_memory);
  typed_message->~BoundingBoxes();
}

size_t size_function__BoundingBoxes__bboxes(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<avai_messages::msg::BoundingBox> *>(untyped_member);
  return member->size();
}

const void * get_const_function__BoundingBoxes__bboxes(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__BoundingBoxes__bboxes(void * untyped_member, size_t index)
{
  auto & member =
...
void resize_function__BoundingBoxes__bboxes(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<avai_messages::msg::BoundingBox> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBoxes_message_member_array[2] = {
  {
    ...
    offsetof(avai_messages::msg::BoundingBoxes, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(avai_messages::msg::BoundingBoxes, bboxes),  // bytes offset in struct
    nullptr,  // default value
    size_function__BoundingBoxes__bboxes,  // size() function pointer
    get_const_function__BoundingBoxes__bboxes,  // get_const(index) function pointer
    get_function__BoundingBoxes__bboxes,  // get(index) function pointer
    resize_function__BoundingBoxes__bboxes  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBoxes_message_members = {
  ...
  2,  // number of fields
  sizeof(avai_messages::msg::BoundingBoxes),
...
get_message_type_support_handle<avai_messages::msg::BoundingBoxes>()
{
  return &::avai_messages::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, avai_messages, msg, BoundingBoxes)() {
  return &::avai_messages::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}
