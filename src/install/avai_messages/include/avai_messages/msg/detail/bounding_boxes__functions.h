...
#ifndef AVAI_MESSAGES__MSG__DETAIL__BOUNDING_BOXES__FUNCTIONS_H_
#define AVAI_MESSAGES__MSG__DETAIL__BOUNDING_BOXES__FUNCTIONS_H_
 ...
 * calls
 * avai_messages__msg__BoundingBoxes__init().
...
/**
 * It calls
 * avai_messages__msg__BoundingBoxes__fini()
 ...
 * avai_messages__msg__BoundingBoxes__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * avai_messages__msg__BoundingBoxes__Sequence__fini()
 * on the array,
...
#endif  // AVAI_MESSAGES__MSG__DETAIL__BOUNDING_BOXES__FUNCTIONS_H_
