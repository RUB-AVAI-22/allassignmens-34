...
class ImgProcessingNode(Node):
    ...
    def callback(self, msg):
        ...
        prepared_image = torch.from_numpy(cv2.dnn.blobFromImage(original_image, 1, (self.targetWidth, self.targetHeight), swapRG=True crop=False).astype(np.uint8)).to(self.model.device)
